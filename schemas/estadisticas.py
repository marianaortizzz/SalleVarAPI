...
class Estadistica(BaseModel):
    id_estadistica: int = Field(min_length=1, description="Identificador único de la estadística")
    ...
    id_restaurante: int = Field(min_length=1, description="Identificador del restaurante asociado")
